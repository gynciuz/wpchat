  ...
  switch (locale) {
    case "lt":
      return {
        ...
        providerCloud: "Tiekėjas: ChatAdmin Cloud (laukimo sąraše)",
        keyWord: "API raktas",
    ...
    case "ru":
      return {
        ...
        providerCloud: "Провайдер: ChatAdmin Cloud (в листе ожидания)",
        keyWord: "API-ключ",
    ...
    case "pl":
      return {
        ...
        providerCloud: "Dostawca: ChatAdmin Cloud (lista oczekujących)",
        keyWord: "klucz API",
    ...
    default:
      return {
        ...
        providerCloud: "Provider: ChatAdmin Cloud (waitlisted)",
        keyWord: "API key",
