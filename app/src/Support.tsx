  ...
  switch (locale) {
    case "lt":
      return {
        ...
        helpIntro: "Klauskite, kaip naudotis ChatAdmin — pvz. „kaip gauti API raktą?“ arba „kodėl neveikia užsakymų sąrašas?“.",
    ...
    case "ru":
      return {
        ...
        helpIntro: "Спросите, как пользоваться ChatAdmin — например «как получить API-ключ?» или «почему не работает список заказов?».",
    ...
    case "pl":
      return {
        ...
        helpIntro: "Zapytaj, jak korzystać z ChatAdmin — np. „jak zdobyć klucz API?” albo „czemu nie działa lista zamówień?”.",
    ...
    default:
      return {
        ...
        helpIntro: "Ask how to use ChatAdmin — e.g. “how do I get an API key?” or “why isn't the orders list working?”.",
