...
class OnboardingStatusTest extends TestCase {
    ...
    public function test_status_reports_api_key_set_via_option(): void {
        ...
        // defines CHATADMIN_ANTHROPIC_API_KEY for the rest of the process; once
        ...
        if (defined('CHATADMIN_ANTHROPIC_API_KEY') && CHATADMIN_ANTHROPIC_API_KEY) {
            $this->markTestSkipped('CHATADMIN_ANTHROPIC_API_KEY already defined by another test in this process.');
        }
        \update_option('chatadmin_settings', ['anthropic_api_key' => 'sk-ant-abc1234567890', 'model' => 'claude-sonnet-4-6']);
